...
call "Development\Scripts\Windows\CallBuildTool.bat" -log -arch=x64 -dotnet=10 -configuration=Development -platform=Windows -buildTargets=FlaxEditor -build -BuildBindingsOnly
if %errorlevel% neq 0 exit /b %errorlevel%
cd ..
