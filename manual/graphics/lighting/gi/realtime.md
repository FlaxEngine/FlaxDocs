...
Use **View -> Debug View -> Global Illumination** to preview DDGI probes in a viewport. This can be usefull to analyze problems with GI in your scene. Probes are using automatic relocation in the local neighberhood to prevent intersecting with the scene geometry thus it might be essential to debug this view.
