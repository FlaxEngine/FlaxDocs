...
Build scripts are using C# 14 with full .NET 10 support. Additionally Flax.Build assembly is referenced with many useful utilities to use during build setup like:
