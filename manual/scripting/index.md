...
Currently the newest **C# 14** version is fully supported. Flax Editor requires [.NET SDK 10](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) to be installed on a system.
